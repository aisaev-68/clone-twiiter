    ...
    a55b: function (e, n, t) {
      ...
      var r = t("7a23"),
        ...
        i = Object(r["h"])(
          "div",
          { class: "login-header" },
          [Object(r["h"])("h2", null, "Log in to Twitter")],
          -1
        ),
        s = { class: "login-form" },
        c = { class: "login-form-item" },
        u = Object(r["h"])("label", { for: "username" }, "Username", -1),
        l = { class: "login-form-item" },
        d = Object(r["h"])("label", { for: "password" }, "Password", -1),
        p = Object(r["h"])(
          "div",
          { class: "login-footer" },
          [
            Object(r["h"])("p", null, [
              Object(r["h"])("span", null, "Forgot password?"),
              Object(r["h"])("span", { class: "dot" }, "·"),
              Object(r["h"])("span", null, "Sign up for Twitter"),
            ]),
          ],
          -1
        );
      function h(e, n, t, h, f, b) {
        ...
        return (
          Object(r["u"])(),
          Object(r["g"])("div", o, [
            Object(r["h"])("div", a, [Object(r["k"])(m, { icon: "twitter" })]),
            i,
            Object(r["h"])("div", s, [
              Object(r["h"])("div", c, [
                Object(r["K"])(
                    ...
                    "input",
                    {
                      ...
                      onKeypress:
                        ...
                        (n[1] = Object(r["L"])(
                          function () {
                            return (
                              b.handleLogin && b.handleLogin.apply(b, arguments)
                            );
                          },
                          ["enter"]
                        )),
        ...
        j = {
          ...
          methods: {
                      ...
                      while (1)
                        switch ((e.prev = e.next)) {
                          ...
                          case 6:
                            return (
                              (o = r.data.user),
                              (a = new w["AvatarGenerator"]()),
                              (i = a.generateRandomAvatar(o.id)),
                              this.$store.dispatch("setLoginInfo", {
                                ...
                                profile: {
                                  ...
                                  pic_full: i,
                                  pic_cover:
                                    "https://pbs.twimg.com/profile_banners/1142171408916762624/1605471218/1500x500",
                                  description: "😎😎",
                                  nickname: o.name,
                                  name: o.name,
            ...
            validateForm: function () {
              (this.validationError.username = !1),
                (this.validationError.password = !1),
                this.userInfo.username.length < 5 &&
                  (this.validationError.username = !0),
                this.userInfo.password.length < 5 &&
                  (this.validationError.password = !0);
            },
          },
        };
      t("9c17");
